	...
	*/
	...
	insertApplication:function(user, callback){
		global.cryptPassword(user.password, function (err, hash){
			...
			var query = 'INSERT INTO applications ("firstname","lastname","email","password","swag_size","attend_school","school","state","country","city","zip","travel","venmo","food_vegetarian","food_vegan","food_glutenfree","food_pescetarian","food_dairyfree","food_kosher","food_halal","food_other","Github","linkedIn","Dribble","exposure","plan_hardware","plan_hardware_on","plan_mentee","plan_mentor","need_partner","plan_need_partner_skills")'
			query += ' VALUES ('
				+  ' "' + user.firstname + '"'
				+ ', "' + user.lastname + '"'
				+ ', "' + user.email + '"'
